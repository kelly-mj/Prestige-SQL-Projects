...
UNION SELECT NULL, 'Program Totals:', NULL, NULL, NULL, NULL

UNION (		-- Count by program
	SELECT NULL, CONCAT('<em>', t1.programmeName, '</em>: ', COUNT(t1.idNumber))
	, NULL, NULL, NULL, NULL
FROM (
	SELECT S.idNumber, P.programmeName, P.programmeId
