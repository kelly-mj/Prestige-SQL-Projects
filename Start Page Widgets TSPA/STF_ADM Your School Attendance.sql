-- [TSPA] STF_ADM Your School Attendance
...
LEFT OUTER JOIN LeavesOfAbsence LOA ON SDT.studentId = LOA.studentId AND LOA.isActive = 1
LEFT OUTER JOIN
	(SELECT
		idNumber,
		userId,
...
WHERE SDT.<ADMINID> AND (SDT.isActive = 1 OR SDT.isActive = 12)
