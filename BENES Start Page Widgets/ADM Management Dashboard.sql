...
SELECT CONCAT('<a target="_blank" href="https://benes.orbund.com/einstein-freshair/view_startpage_query_report.jsp?queryid=234&type=spquery">New leads in the past 30 days (link to list):</a>') AS 'Student Type'
