-- [SHELL] Query Report: Dictionary Differences
-- Kelly MJ | 4/17/2019
...
FROM (
    ...
    AND languageId = (SELECT languageId FROM Languages WHERE languageName = IF('[?Language (leave blank for default)]' = '', 'Prestige', '[?Language (leave blank for default)]'))) T
